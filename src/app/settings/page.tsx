      ...
      <div style={{ marginLeft: '260px', flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
          <div style={{ maxWidth: '640px', margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', fontWeight: '400', color: '#1A2F23', marginBottom: '6px' }}>Settings</h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              {/* Account Card */}
              <div style={{ background: '#FFFFFF', border: '1px solid rgba(26,46,26,0.12)', borderRadius: '8px', padding: '24px' }}>
                <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', color: '#1A2F23', marginBottom: '16px' }}>Account</h2>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ fontSize: '11px', background: '#3D6B3D', color: '#FFFFFF', borderRadius: '10px', padding: '2px 8px', fontFamily: 'system-ui, sans-serif' }}>Academic Pro</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid rgba(26,46,26,0.12)', borderRadius: '8px', padding: '24px' }}>
                <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '20px', color: '#1A2F23', marginBottom: '16px' }}>Research Engine</h2>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div>
                    <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: '14px', color: '#4A5248', marginBottom: '12px' }}>Preferred AI Model</p>
                    <div style={{ display: 'flex', gap: '12px' }}>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'system-ui, sans-serif', fontSize: '14px', color: '#1A2F23' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '16px' }}>
                <button 
                  style={{ background: '#1A2F23', color: '#FFFFFF', border: 'none', borderRadius: '6px', height: '40px', padding: '0 24px', fontSize: '14px', fontFamily: 'system-ui, sans-serif', fontWeight: '500', cursor: 'pointer', transition: 'background 0.15s' }}
