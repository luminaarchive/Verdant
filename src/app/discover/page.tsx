      ...
      <div style={{ marginLeft: '260px', flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
          <div style={{ maxWidth: '960px', margin: '0 auto' }}>
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', fontWeight: '400', color: '#1A2F23', marginBottom: '6px' }}>Discover</h1>
            ...
            <Link href="/research?q=Global+Soil+Depletion" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#FFFFFF', border: '1px solid rgba(45,74,45,0.15)', borderRadius: '12px', padding: '24px', display: 'flex', gap: '24px', marginBottom: '16px', transition: 'border-color 0.15s' }}
              ...
              >
                <div style={{ flex: '0 0 70%' }}>
                  ...
                  <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '22px', fontWeight: '400', color: '#1A2F23', lineHeight: '1.35', marginBottom: '12px' }}>Global Soil Depletion: The Silent Crisis Beneath Our Feet</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', paddingBottom: '32px' }}>
              {gridCards.map((card) => (
                <Link key={card.title} href={`/research?q=${encodeURIComponent(card.title)}`} style={{ textDecoration: 'none' }}>
                  <div style={{ background: '#FFFFFF', border: '1px solid rgba(45,74,45,0.12)', borderRadius: '10px', padding: '20px', cursor: 'pointer', height: '100%', transition: 'border-color 0.15s' }}
                    onMouseEnter={e => (e.currentTarget as HTMLElement).style.borderColor = '#1A2F23'}
                  ...
                  >
                    ...
                    <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '16px', fontWeight: '400', color: '#1A2F23', lineHeight: '1.4', marginBottom: '8px' }}>{card.title}</h3>
