      ...
      <div style={{ marginLeft: '220px', flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
          <div style={{ maxWidth: '960px', margin: '0 auto' }}>
            ...
            <div style={{ background: '#F5F2EB', border: '1px solid rgba(45,74,45,0.15)', borderRadius: '12px', padding: '24px', display: 'flex', gap: '24px', marginBottom: '16px' }}>
              <div style={{ flex: '0 0 70%' }}>
                ...
                <a href="/research?q=Global+Soil+Depletion" style={{ fontSize: '13px', fontFamily: 'system-ui, sans-serif', color: '#3D6B3D', textDecoration: 'none', fontWeight: '500' }}>Begin Research →</a>
              </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', paddingBottom: '32px' }}>
              {gridCards.map((card) => (
                <div key={card.title} style={{ background: '#F5F2EB', border: '1px solid rgba(45,74,45,0.12)', borderRadius: '10px', padding: '20px', cursor: 'pointer' }}>
