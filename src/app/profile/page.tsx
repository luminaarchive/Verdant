            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button 
                  ...
                  style={{ background: '#F5F2EB', color: '#4A5248', border: '1px solid rgba(26,46,26,0.15)', borderRadius: '6px', height: '36px', padding: '0 16px', fontSize: '13px', fontFamily: 'system-ui, sans-serif', fontWeight: '500', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', transition: 'background 0.15s, color 0.15s' }}
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1A2E1A'; (e.currentTarget as HTMLElement).style.color = '#F5F2EB'; (e.currentTarget as HTMLElement).style.borderColor = '#1A2E1A' }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = '#F5F2EB'; (e.currentTarget as HTMLElement).style.color = '#4A5248'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(26,46,26,0.15)' }}
                >
